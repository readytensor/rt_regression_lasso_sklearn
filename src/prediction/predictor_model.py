...
class Regressor:
    """A wrapper class for the Lasso regressor.
    ...
    def evaluate(self, test_inputs: pd.DataFrame, test_targets: pd.Series) -> float:
        """Evaluate the Lasso regressor and return coefficient of
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Lasso regressor to disk.
    ...
    def load(cls, model_dir_path: str) -> "Regressor":
        """Load the Lasso regressor from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            regressor: A new instance of the loaded Lasso regressor.
        """
